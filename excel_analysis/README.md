...
## 1.1. AdventureWorks Sales Dashboard

**Goal**  
Transform transactional sales data into a structured performance overview.

**What was done**
- Combined multiple related tables
- Built calculated metrics
- Created pivot-based summaries
- Prepared a compact reporting sheet
